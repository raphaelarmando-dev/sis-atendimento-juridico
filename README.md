...
- [ ] Refatoração: Criação da classe abstrata Pessoa e ajuste de herança em Advogado.
- [ ] Criação e mapeamento da entidade Cliente (Herdando de Pessoa) + Teste de inserção na Main.
